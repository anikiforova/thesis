...
library(gridExtra)
p = getCTRPlot(all, c(0,0.12), "Simulation Type:", "bottom")+
    theme(legend.justification = c(1, 0), 
          legend.position = c(1, 0),  
          legend.box.background = element_rect(colour = "black"))
p

ggsave(paste(imageLocation, "SimulationComparison.png", sep=""), plot=p, width = 15, height = 10, units = "cm")
```
...
simulated_data2$Factor = "LinUCB /w Budgets"
...
p2 = getCTRPlot(all, c(0,0.12), "Simulation Type:", "right") + 
...
ggsave(paste(imageLocation, "SimulationAlgoComparison.png", sep=""), plot=p2, width = 15, height = 10, units = "cm")
