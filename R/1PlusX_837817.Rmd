...
campaignIds = c(837817, 722100, 809153)
files =  c("Random")
...
ggsave(paste(imageLocation, "RecommendationSize.png"), plot=g, width = 20, height = 9, units = "cm")
g
```
...
g
ggsave(paste(imageLocation, paste(campaign_id, "AllAlgorithms.png", sep="")), plot=g, width = 19, height = 10, units = "cm")
```
\newpage
