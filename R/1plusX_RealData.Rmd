...
files = c("Regression", "LinUCB_Disjoint", "TS_Lin", "NN")
data = prepData(files)
...
data = data[(data$Method == "Regression" & data$RecommendationSizePercent == "0.021" ) |
              ...
              (data$Method == "Random") | 
              (data$Method == "NN_AdamOptimizer" & data$RecommendationSizePercent == 0.1) | 
...
files = c("LinUCB_Disjoint", "LinUCB_Disjoint_Test", "Random", "GP_Clustered_10")
data = prepData(files)
...
data = data[(data$Method == "LinUCB_Disjoint" & data$RecommendationSizePercent == 0.02 & data$Alpha == 0.02) |
            ...
            (data$Method == "Random") | 
              (data$Method == "GP_Clustered_10" & data$RecommendationSizePercent == 0.1 ),]

ggplot(data, aes(x=TotalImpressions, y=Impressions, colour=Factor)) + 
  geom_line() +
   expand_limits(y=c(0,1.2)) + 
   scale_x_continuous(labels=formatterM())+
    theme_bw() + ggtitle("All (Cumulative)") +
