...
data$Factor = factor(data$Factor)
#data$Percent = data$BatchCTR * 100
p = getCTRPlot(data, c(0,0.3), "Target Split:") + 
  ggtitle("Target Split") + 
  theme(plot.title = element_text(size=15,hjust = 0.5))

ggsave(paste(imageLocation, "TargetSplitEffect.png", sep=""), plot=p, width = width * 2, height = 11, units = "cm")
p
```
...
data$Factor = factor(data$Factor)
#data$Percent = data$BatchCTR * 100
p = getCTRPlot(data, c(0,0.3), "Early Update:") + 
  ggtitle("Early Update")+ 
  theme(plot.title = element_text(size=15,hjust = 0.5))

ggsave(paste(imageLocation, "EarlyUpdateEffect.png", sep=""), plot=p, width = width * 2, height = 11, units = "cm")
p
```
...
data$Factor = factor(data$Factor)
#data$Percent = data$BatchCTR * 100
p = getCTRPlot(data, c(0,0.3), "Target % Reduction:") + 
  ggtitle("Target % Reduction")+ 
  theme(plot.title = element_text(size=15,hjust = 0.5))

ggsave(paste(imageLocation, "TargetSizeEffect.png", sep=""), plot=p, width = width * 2, height = 11, units = "cm")
p
...
data$Factor = factor(data$Factor)
#data$Percent = data$BatchCTR * 100
p = getCTRPlot(data, c(0,0.3), "Crop %:") + 
  ggtitle("Crop Percent")+ 
  theme(plot.title = element_text(size=15,hjust = 0.5))

ggsave(paste(imageLocation, "CropPercentEffect.png", sep=""), plot=p, width = width * 2, height = 11, units = "cm")
p
```
...
#data$Percent = data$BatchCTR * 100
p = getCTRPlot(data, c(0,0.3), "Normalized:") + 
  ggtitle("Normalization effect")+ 
  theme(plot.title = element_text(size=15,hjust = 0.5))

ggsave(paste(imageLocation, "NormalizationEffect.png", sep=""), plot=p, width = width * 2, height = 11, units = "cm")
p
