...
a = pd.date_range(start='15/8/2018', end='20/08/2018') 
...
for date in a:
	...
	output = open("{0}/sorted_time_impressions_{1}_{2}.csv".format(hindsight_multi_campaign_path, date, simulation_index), "w")
