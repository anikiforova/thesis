...
simulation_controller = SimulationController(reinitialize_calibration = True)

# testsMeta = get_simulation_lin_multi_target_test(meta, 6)

# output_path = "./Results/{0}/Simulation/{1}_Test2.csv".format(meta.campaign_id, meta.algo_name)
# output_log_path = "./Log/{0}/Simulation/{1}_Test2.csv".format(meta.campaign_id, meta.algo_name)
# output_campaign_log_path = "./Log/{0}/Simulation/Campaign_Log_Test2.csv".format(meta.campaign_id)
